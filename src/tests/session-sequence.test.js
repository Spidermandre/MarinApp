...
import { hoursUntil48h, isProgramComplete, nextSessionNumber, phaseOfSession, setsForSession, weekOfSession, workoutForSession, workoutIdForSession, } from '../lib/session-sequence';
const log = (n, status, finishedAt) => ({
    sessionNumber: n,
