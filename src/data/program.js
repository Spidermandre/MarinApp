...
export const cooldown = {
    min: 3,
    description: 'Allungamento leggero, 30" per posizione: flessori dell’anca in affondo, glutei (gamba incrociata da supina), pettorali al muro.',
};
...
const core = (rounds, restBetweenExercisesSec, restBetweenRoundsSec, items) => ({ rounds, restBetweenExercisesSec, restBetweenRoundsSec, items });
const cardio = (b) => b;
        ...
        strength: [
            {
                ...
                restSec: 105,
                rir: '1-2',
                notes: 'Rec 90–120". Se oltre 16–20 kg diventa scomodo da tenere, passa allo squat al multipower',
            },
            {
                exerciseId: 'db-bench-press',
                sets: 3,
...
export const cardioZonesNote = 'FC massima stimata con la formula di Tanaka (208 − 0,7 × età) ≈ 182 bpm; zona 2 ≈ 60–70%. È una stima: la percezione (RPE) ha la priorità.';
